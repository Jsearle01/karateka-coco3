-- scene6_stage1_live.lua — Jay's live MAME visual gate for the Stage-1 Fuji backdrop.
-- Boots coco3, loads scene6_stage1_driver.bin, sets PC=entry, and lets it run so the
