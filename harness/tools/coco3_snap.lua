-- coco3_snap.lua — boot coco3 to BASIC, DECB-load S_BIN, set PC=exec, run to a stable frame,
-- then screen:snapshot() to capture MAME's ACTUAL rendered RGB (composite decode) — for the
-- palette study (port's real $FFB1/$FFB2 colors). Snapshot -> -snapshot_directory/coco3/NNNN.png.
...
local st="wait"
_G._sn = emu.add_machine_frame_notifier(function()
