* tests/scripted/scene6_climb_crawl_driver_a.s  — VARIANT (a): WALL-TOP DELTA.
* Byte-identical to the fallback scene6_climb_crawl_driver.s EXCEPT it includes
* scene6_cliff_variant_a.s (the 3-change wall-top delta: drop col-11 post; AA23/AA31
* at Apple bytes 23 & 35 sub-byte shift 5 -> CoCo3 sub 2; masked-not-opaque). Cliff-face
* stays the blue-fill striations. For the three-up live gate vs the fallback + variant (b).
*
